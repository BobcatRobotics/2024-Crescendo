...
import frc.lib.util.BobcatLib.Swerve.SwerveModuleIOFalcon;
import frc.lib.util.BobcatLib.Swerve.SwerveModuleIOSim;
...
public class RobotContainer {
        ...
        public RobotContainer() {
                switch (Constants.currentMode) {
                        ...
                        case REAL:
                                m_intakeVision = new Vision(new VisionIOLimelight(LimelightConstants.intake.constants));// need
                                                                                                                        // index
                                                                                                                        // and
                                                                                                                        // limelight
                                                                                                                        // constants
                                ...
                                m_shooterRightVision = new Vision(
                                                new VisionIOLimelight(LimelightConstants.shooterRight.constants));
                                m_shooterLeftVision = new Vision(
        ...
        public void configureAutos(){
                ...
                NamedCommands.registerCommand("SpinUp", new InstantCommand(
                                () -> m_shooter.setSpeed(ShooterConstants.fastShooterRPMSetpoint,
                                                ShooterConstants.fastShooterRPMSetpoint)));
                ...
                // autoChooser.addOption("CenterShootNScoot", new
                // PathPlannerAuto("centerShootNScoot"));
        ...
        public void configureBindings() {
                ...
                // .whileTrue(new StartEndCommand(() -> m_Spivit.setPercent(-0.15),
                // m_Spivit::stopMotorFeedforward,
                // m_Spivit));
                // // manual up
                // gp.axisLessThan(5, -.6)
                // .whileTrue(
                // new StartEndCommand(() -> m_Spivit.setPercent(0.20),
