...
/**
 * Stolen from 6328, who stole it from 254
 *
...
public class SwerveSetpointGenerator {
  ...
  /**
   * factory method equivalent to a default constructor for {@link SwerveSetpoint SwerveSetpoint}
   */
  public static SwerveSetpoint getBlankSetpoint(){
    return new SwerveSetpoint(new ChassisSpeeds(),  
